        ...
        <div class="col-md-9">
            <div class="thumbnail">
              ...
              <div class="caption-full">
                  <h4 class="pull-right">{{$product->pricing}} G</h4>
            ...
            <div class="well" id="reviews-anchor">
              ...
              <div class="text-right">
                <a href="#reviews-anchor" id="open-review-box" class="btn btn-success btn-green">留言</a>
              </div>
              <div class="row" id="post-review-box" style="display:none;">
                <div class="col-md-12">
                  {!! Form::open() !!}
                  {!! Form::hidden('rating', null, array('id'=>'ratings-hidden')) !!}
                  {!! Form::textarea('comment', null, array('rows'=>'5','id'=>'new-review','class'=>'form-control animated','placeholder'=>'请留言...')) !!}
                  <div class="text-right">
